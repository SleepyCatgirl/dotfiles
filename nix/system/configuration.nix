...
#
  ...
  # Define a user account. Don't forget to set a password with ‘passwd’.
   users.users.senchou = {
     isNormalUser = true;
     extraGroups = [ "wheel" "networkmanage" "audio" "video" ]; # Enable ‘sudo’ for the user.
     home = "/home/senchou";
   };
  ...
  # $ nix search wget
   environment.systemPackages = with pkgs; [
     ...
     gcc gdb # C++ Dev
     haskell-language-server ghc # Haskell dev
     xmobar dmenu pywal polybarFull bspwm sxhkd # WM aesthics
  ...
  #ZFS
  boot.kernelParams = [ "zfs.zfs_arc_max=326870912" "nohibernate" ]; # ZFS hibernating issue
